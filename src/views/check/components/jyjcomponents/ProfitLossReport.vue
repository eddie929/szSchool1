<template>
  <div>
    <div style="margin-bottom:5px;margin-left:20px">
      ...
      <el-button size="small" type="success" @click="openWindows"
        >盈亏详情</el-button
      >
    </div>
...
<script>
import { proportionwholedata, get_allschool } from "@/api/inventoryhandle";
...
export default {
  ...
  methods: {
    ...
    onloads() {
      ...
      // console.log("来了吗1");
      // console.log("来了吗1", this.pdID);
      // console.log("来了吗1", this.qualtityMoney);
