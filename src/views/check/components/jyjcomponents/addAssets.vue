    ...
    btnok(form) {
      ...
      this.$refs[form].validate(valid => {
        if (valid) {
          ...
          // this.form.存放地点value = this.$refs.AssetAddress.inputValue;
          // this.form.存放地点value = this.form.存放地点[0];
          // this.form.存放地点二级 = this.form.存放地点[1];
          if (
            this.form.存放地点value == "" ||
          ...
          this.form.存放地点一级 = this.form.存放地点value.存放地点一级ID;
          this.form.存放地点二级 = this.form.存放地点value.存放地点二级ID;
          this.form.存放地点 = this.$refs.AssetAddress.inputValue;
          if (
            this.form.归属部门value == "" ||
          ...
          this.form.所属部门 = this.form.归属部门value.部门名称;
          ...
          // this.form.资产分类 = data[1];
          // console.log("看看吧:", this.$refs.AssetClasses.currentLabels);
          // return;
          // this.form.一级分类名称 = this.$refs.AssetClasses.inputValue.split("/");
          this.form.一级分类名称 = this.$refs.AssetClasses.inputValue;
          ...
          // console.log("this.form.二级类别,", this.form.二级分类名称);
          // return;
          ...
          this.form.三级归属部门Id = this.form.归属部门value.部门Id;
          this.form.资产状态 = "空闲中";
          if (this.$refs.AssetClasses.inputValue == "图书、档案") {
            this.form.净值 = this.form.原值;
            this.$emit("putData", this.form);
            // for (var i = 0; i < this.form.数量; i++) {

            // }
          } else {
            this.form.原值 = this.form.原值 / this.form.数量;
            this.form.净值 = this.form.原值;
            let collection = JSON.parse(JSON.stringify(this.form));
            this.form.数量 = 1;
            for (var i = 0; i < collection.数量; i++) {
              this.$emit("putData", this.form);
            }
          }
