  ...
  >
    <el-form ref="ruleForm" :label-position="labelPosition" :model="form">
      ...
      >
        ...
        <el-table-column prop="原值" label="原值" align="right" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="净值" label="净值" align="right"> </el-table-column>
        <el-table-column
          prop="存放地点"
          label="存放地点"
          :show-overflow-tooltip="true"
      ...
      >
        ...
        >
          ...
          <el-button class="el-icon-close" @click="btnok(-1)"> 退 回</el-button>
        </div>
      </el-dialog>
    </el-form>
    <!-- <div
