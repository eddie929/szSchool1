    ...
    >
      ...
      <el-drawer :visible.sync="drawer" :direction="direction"
        ><div style="margin: 0 5% 0 5%">
          ...
          >
            <el-select
              v-model="pageinfo.changecontent"
              placeholder="请选择"
              clearable
            >
              <el-option
...
export default {
  ...
  methods: {
    ...
    onload() {
      ...
      get_assettransfer(this.pageinfo).then(res => {
    ...
    onloads() {
      ...
      this.loading = true;
      get_assettransferdetail(this.pageinfo).then(res => {
    ...
    handleCommanddao(row) {
      if (row == "导出选中") {
        ...
        data.pageNum = 1;
        data.pageSize = 10000;
        get_assettransfer(data).then(res => {
