  ...
  methods: {
    ...
    handleCommanddao(row) {
      if (row == "导出选中") {
        ...
        data.pageNum = 1;
        data.pageSize = 10000;
        get_assetshandle(data).then(res => {
    ...
    onload() {
      ...
      this.loading = true;
      get_assetshandle(this.pageinfo).then(res => {
    ...
    onloads() {
      ...
      this.loading = true;
      get_assetshandledetail(this.pageinfo).then(res => {
