      ...
      >
        ...
        >
          ...
          >
            ...
            <br>
            <el-tag style="margin-top: 10px;" effect="plain" type="info">
              位置： {{ item.位置数量 }}
            </el-tag>
          </div>
        </el-card>
...
<script>
import jzw from '@/assets/sysimages/建筑物.png'
import { get_buildingview } from '@/api/datacenterhandle'
export default {
  data() {
    return {
      ul: jzw,
