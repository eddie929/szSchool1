  ...
  <div>
    <div style="margin: 1% 1% 0% 1%">
      ...
      <div style="text-align: center; margin: 22px 0px">
        ...
        <el-button style="width: 10%" class="el-icon-close" @click="back()">
          取 消</el-button
        >
...
export default {
  ...
  methods: {
    back() {
      this.$router.push({ path: "/assetDisposal" });
    },
    btnok() {
      ...
      if (this.pageinfo.categoryname == "报废") {
        ...
        for (let i of this.$refs.table.selection) {
          this.$refs.AddDis.form.资产编号 = i.资产编号;
        }
        this.$refs.AddDis.get_flowDocumentNo();
        this.$refs.AddDis.onload();
        ...
        for (let i of this.$refs.table.selection) {
          this.$refs.AddFlow.form.资产编号 = i.资产编号;
        }
        this.$refs.AddFlow.get_flowDocumentNo();
        this.$refs.AddFlow.onload();
      }
    },
    // 移除待处置库
    deletable() {
    ...
    onload() {
      ...
      var data = {
        ...
        分类名称: this.pageinfo.categoryname,
  ...
  beforeMount() {
    ...
    if (this.$route.query.data === undefined) {
      ...
      if (this.$route.query.data.流程状态 === "已退回") {
