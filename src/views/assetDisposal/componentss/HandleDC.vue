    ...
    ><el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="处置单" name="first">
        ...
        <el-form ref="ruleForm" :label-position="labelPosition" :model="sform">
          ...
          <el-row :gutter="24" style="margin-top: 1%" v-if="form.流程代码 > 3">
            <el-col :span="8">
              <el-form-item
                label="主管领导"
                label-width="140px"
          ...
          <el-row :gutter="24" style="margin-top: 1%" v-if="form.流程代码 == 4">
            <el-col :span="8">
              <el-form-item
                label="批复文号"
                label-width="140px"
            ...
            <!-- <el-col :span="16" v-if="form.流程代码 > 4">
                  <el-form-item
                    label="调出单位财务"
                    label-width="140px"
                    prop="remark"
          ...
          <el-row :gutter="24" style="margin-top: 1%" v-if="form.流程代码 > 5">
            <!-- <el-col :span="8">
                  <el-form-item
                    label="调入单位确认时间"
                    label-width="140px"
            ...
            <el-col :span="8" v-if="form.流程代码 > 6">
              <el-form-item
                label="调出单位记账人"
                label-width="140px"
                prop="调出单位财务记账人员名称"
          ...
          <el-row :gutter="24" style="margin-top: 1%" v-if="form.流程代码 > 7">
            <el-col :span="8">
              <el-form-item
                label="调入单位财务"
                label-width="140px"
...
export default {
  ...
  methods: {
    //   提交
    btnok(val) {
      // console.log("val", this.form.流程代码);
      if (this.form.流程代码 == 1) {
        if (
